...
class CustomLoginViewTests(TestCase):
    ...
    def test_login_redirects_authenticated_user(self):
        """
        Test that an authenticated user is
        redirected from the login page to the 'tasks' page.
        """
        ...
        """
        Test that the login view renders
        the correct template for anonymous users.
        """
    ...
    def test_login_view_renders_for_anonymous_user(self):
        ...
        and is redirected to the 'tasks' page.
        """
